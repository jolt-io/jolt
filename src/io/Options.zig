...
io_uring: struct {
    /// Enables submission queue polling (`IORING_SETUP_SQPOLL` flag).
    ///
    /// Consumes more CPU but submits I/O requests without a syscall.
    /// Think of it like a guard around `io_uring_enter`.
    //sqe_polling: bool = false,
